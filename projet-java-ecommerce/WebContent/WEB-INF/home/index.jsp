...
<body>
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav mr-auto">
						<li class="nav-item dropdown"><a
							class="nav-link dropdown-toggle" href="produit"
	...
	<section id="steps">
		<div class="wrapper">
			<ul>
				...
				<li id="step-1">
					<h5>
						<a href="inscription">Inscription Client</a>
					</h5>
					<p>Identifier votre produit qui seras garantie.</p>
				</li>
				<li id="step-2">
					<h5>
						<a href="inscriptionVendeur">Inscription Vendeur</a>
					</h5>
					<p>Proposer vos produits et nous nous occupons de tous.</p>
				</li>
				<li id="step-2">
					<h5>
						<a href="produit">LAPTOP</a>
					</h5>
					<p>Des ordinateurs dernier cri.</p>
				</li>
			</ul>
	...
	<footer>
		...
		<h1>
			HIGH TECH<span class="orange">.</span>
		</h1>
